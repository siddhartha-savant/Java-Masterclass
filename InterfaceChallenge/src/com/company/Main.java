...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ISaveable werewolf = new Monster("Werewolf",200); //This can be Monster werewolf = new ... also
        System.out.println();
    ...
    public static void loadObject(ISaveable objectToLoad){  //The load method is nothing but to save new values
        ArrayList<String> values = readValues();            //for the fields of the object i.e. to load different
        objectToLoad.read(values);                          //values.

        //The parameter objectToLoad is using the method read() which is of type void. Over here we are calling the
        //method read() from class Player for sid object and from class Monster for werewolf object.
    }
